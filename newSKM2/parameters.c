...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
	...
	PRIVATE CONST stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX][PARAM_SURA_MAX] = {
		...
		{	//	FF	速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp		壁kd
			...
			{ 0,		5,	0.03,	0,	0.1,	0,	0.5,		0.01,		0.008,		2,		0,		0,		0,	},	// PARAM_ACC_SURA
			{ 0,		5,	0.03,	0,	0.1,	0,	0.5,		0.01,		0,		2,		0,		0,		0,	},	// PARAM_CONST_SURA
			{ 0,		5,	0.03,	0,	0.1,	0,	3,		0.01,		0.008,		10,		0.5,		0,		0,	},	// PARAM_DEC_SURA
