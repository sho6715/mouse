...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
	...
	PRIVATE CONST stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX][PARAM_SURA_MAX] = {
		...
		{	//	FF	速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp		壁kd
			...
			{ 0,		3,	0.03,	0,	0,	0,	0.73,		0.0115,		0.0028,		7,		0,		0,		0,	},	// PARAM_ACC_SURA
			{ 0,		3,	0.03,	0,	0,	0,	0.73,		0.0115,		0.0028,		7,		0,		0,		0,	},	// PARAM_CONST_SURA
			{ 0,		3,	0.03,	0,	0,	0,	0.73,		0.0115,		0.0028,		7,		3,		0,		0,	},	// PARAM_DEC_SURA
			{ 0,		3,	0.03,	0,	0.1,	0,	0.2,		0.005,		0,		2,		0,		0.6,		0.4,	},	// PARAM_EXIT_SURA
		},
		/* 通常(PARAM_NORMAL)500 *///角速度kp500 角度kp25000
		{	//	FF	速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp		壁kd
			{ 0,		3,	0.03,	0,	0.1,	0,	0.2,		0.005,		0,		2,		0,		0.5,		0.3,	},	// PARAM_ENTRY_SURA
			{ 0.004,		3,	0.03,	0,	0,	0,	0.62,		0.0115,		0.00,		2,		0,		0,		0,	},	// PARAM_ACC_SURA
			{ 0,		3,	0.03,	0,	0,	0,	0.62,		0.0115,		0.00,		2,		0,		0,		0,	},	// PARAM_CONST_SURA
			{ 0,		3,	0.03,	0,	0,	0,	0.62,		0.0115,		0.00,		2,		3,		0,		0,	},	// PARAM_DEC_SURA
			{ 0,		3,	0.03,	0,	0.1,	0,	0.2,		0.005,		0,		2,		0,		0.6,		0.4,	},	// PARAM_EXIT_SURA
		},
		/* 高速(PARAM_FAST) 600*/
		{	//	FF	速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp		壁kd
			{ 0,		3,	0.03,	0,	0.1,	0,	0.1,		0.01,		0,		2,		0,		0.5,		0.3,	},	// PARAM_ENTRY_SURA
			{ 0,		5,	0.03,	0,	5,	0,	0.5,		0.008,		0.8,		2,		0,		0,		0,	},	// PARAM_ACC_SURA
			{ 0,		5,	0.03,	0,	5,	0,	0.5,		0.008,		0.8,		2,		0,		0,		0,	},	// PARAM_CONST_SURA
			{ 0,		5,	0.03,	0,	5,	0,	2.3,		0.008,		0.8,		10,		0.5,		0,		0,	},	// PARAM_DEC_SURA
