...
/* ============== */
	...
	PRIVATE CONST stGAIN f_StGainData[PARAM_MOVE_SPEED_MAX][PARAM_ST_MAX] = {
		...
		{	//	FFSA	FFS		FFAA	FFA		速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp	角度ki	壁kp	壁kd
			{ 0.01,		0.2,	0,		0,		3,		0.03,		0,		0,		0,		0.1,		0.01,		0,		0.5,		0,		0.2,	0.0,	},	// PARAM_ACC
			{ 0.01,		0.2,	0,		0,		3,		0.03,		0,		0,		0,		0.1,		0.01,		0,		0.5,		0,		0.2,	0.0,	},	// PARAM_CONST
			{ 0.01,		0.2,	0,		0,		3,		0.03,		0,		6,		0,		0.1,		0.01,		0,		0.5,		0,		0.2,	0.0,	},	// PARAM_DEC
...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
			{ 0.01,		0.2,	0,		0,		3,		0.03,		0,		0,		0,		0.1,		0.01,		0,		0.5,		0,		0.2,	0.0,	},	// PARAM_SKEW_ACC
			{ 0.01,		0.2,	0,		0,		3,		0.03,		0,		0,		0,		0.1,		0.01,		0,		0.5,		0,		0.2,	0.0,	},	// PARAM_SKEW_CONST
			{ 0.01,		0.2,	0,		0,		3,		0.03,		0,		6,		0,		0.1,		0.01,		0,		0.5,		0,		0.2,	0.0,	},	// PARAM_SKEW_DEC
...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
	...
	PRIVATE CONST stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX][PARAM_SURA_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) */
		{	//	FFSA	FFS		FFAA	FFA		速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp	壁kd
			{ 0.01,		0.2,	0,		0,		3,		0.03,	0,		0.1,	0,		0.1,		0.01,		0,			0.5,		0,		0.2,		0.0,	},	// PARAM_ENTRY_SURA
			...
			{ 0.01,		0.2,	0,		0,		3,		0.03,	0,		0.1,	0,		0.1,		0.01,		0,			0.5,		0,		0.25,		0.0,	},	// PARAM_EXIT_SURA
		},
		/* 低速(PARAM_SLOW) */
		{	//	FFSA	FFS		FFAA	FFA		速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp	壁kd
			{ 0.01,		0.2,	0,		0,		3,		0.03,	0,		0.1,	0,		0.1,		0.01,		0,			0.5,		0,		0.2,		0.0,	},	// PARAM_ENTRY_SURA
