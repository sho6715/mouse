...
//			{ 0,		3,	0,	0,		0,	0.1,	0.5,		0,		0,		3,		0,		1,		0,	},	// PARAM_BACK_DEC
	...
	PRIVATE CONST stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX][PARAM_SURA_MAX] = {
		...
		{	//	FFSA	FFS		FFAA	FFA		速度kp	速度ki	速度kd	位置kp	位置ki	角速度kp	角速度ki	角速度kd	角度kp		角度ki		壁kp	壁kd
			...
			{ 0.01,		0.2,	0.002,	0.08,	3,		0.03,	0,		0.1,	0,		0.3,		0.02,		0.0,		6,			0.5,		0,		0,	},	// PARAM_ACC_SURA
			{ 0.01,		0.2,	0.002,	0.08,	3,		0.03,	0,		0.1,	0,		0.3,		0.02,		0.0,		6,			0.5,		0,		0,	},	// PARAM_CONST_SURA
			{ 0.01,		0.2,	0.002,	0.08,	3,		0.03,	0,		0.1,	0,		0.3,		0.02,		0.0,		6,			0.8,		0,		0,	},	// PARAM_DEC_SURA
...
PUBLIC void PARAM_makeSra( float f_speed, float f_angAcc, float f_g , enSLA_TYPE en_mode)
{
	...
	switch(en_mode){
		...
		case SLA_N90:
			p_adr->f_escapeLen = f_final_x - f_x;//機体長さ補正分
			p_adr->f_entryLen  = f_final_y - f_y+12;
			break;
